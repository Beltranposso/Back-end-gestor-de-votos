...
const { createUser, DeleteUser, getAllUsers, getUser, updateUser,getUserCordinador,getUserOperador,SetAsistencia,getColumnByCedula,verifyUserByToken,getCargo,getUserONE} = require('../controllers/Controllers.js');
const  {getUsersByAsamblea} = require('../controllers/getUserByasamblea.js')
const router = express.Router();

router.get('/', getAllUsers);
router.get('/:id_card', getUser);
router.get('/GetuserOne/oneuser/:id',getUserONE)

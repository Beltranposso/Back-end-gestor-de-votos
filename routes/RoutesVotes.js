...
const { RegisterVote, getAllVotos, getVotosByid, getvoto, checkVoter,obtenerResultadosPorCard,getOpcionesConQuorumByPregunta ,getProcessedDataByPregunta} = require('../controllers/ControllersVotos.js');

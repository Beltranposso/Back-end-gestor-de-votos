...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-12-2024 a las 10:57:01
...
CREATE TABLE `pregunta` (
  ...
  `TiempoInicio` varchar(110) NOT NULL DEFAULT current_timestamp(),
...
--
ALTER TABLE `asambleas`
  ADD CONSTRAINT `asambleas_ibfk_1` FOREIGN KEY (`UserId`) REFERENCES `app_usuarios` (`id`) ON DELETE SET NULL ON UPDATE SET NULL;
...
--
ALTER TABLE `votes`
  ADD CONSTRAINT `votes_ibfk_1` FOREIGN KEY (`id_option`) REFERENCES `opciones` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
  ADD CONSTRAINT `votes_ibfk_2` FOREIGN KEY (`id_voter`) REFERENCES `usuarios` (`Cedula`) ON DELETE SET NULL ON UPDATE SET NULL,
  ADD CONSTRAINT `votes_ibfk_3` FOREIGN KEY (`id_question`) REFERENCES `pregunta` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
